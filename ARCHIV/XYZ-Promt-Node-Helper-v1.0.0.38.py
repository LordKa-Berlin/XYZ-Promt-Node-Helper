...
VERSION = "V38"  # Version explizit definiert

# Ermittle das Verzeichnis des Skripts und arbeite relativ dazu:
...
row_bez_state = {}
# Für die einzelnen Wert‑Buttons (in gleicher Reihenfolge wie beim Split des Prompts)
row_value_states = {}
...
# Label für Anzeige des aktiven Output-Modus in der Statusleiste
...
def update_button_appearance(btn, state, is_bez=False):
    if state == 0:  # normal
        if is_bez:
            # Bezeichner-Button in Anzeige: Hintergrund auf #212121, Schrift orange
...
# Neuer Output-Modus Bereich: Radiobuttons mit Zeilenumbruch und Import CSV Button rechts daneben
output_frame = tk.Frame(second_frame, bg="#1F1F1F")
