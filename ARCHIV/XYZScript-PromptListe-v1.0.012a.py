...
# Datum: 2025-04-05
# Uhrzeit: 22:15
# Dateispeichername: XYPScript-Promptliste-V1-13
# Beschreibung: Master-Copy-Button eingefügt, Filter reagiert nun sofort auf Eingaben, unabhängig von der Ansicht.
...
filter_var.trace_add("write", lambda *args: update_list())  # Live-Filter aktivieren
...
# --- Zusätzliche Buttons ---
toggle_btn = tk.Button(filter_frame, text="Alle abwählen", command=lambda: toggle_all(), bg="#FFA500", fg="#000000")
toggle_btn.pack(side="right", padx=5)
tk.Button(filter_frame, text="Copy Master", command=copy_master_prompt, bg="#FFA500", fg="#000000").pack(side="right", padx=5)
...
# --- update_list bleibt erhalten ---
# (Siehe vorheriger Block in Canvas oder vorherige Version)
