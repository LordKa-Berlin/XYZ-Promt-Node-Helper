...
# Datum: 2025-04-05
# Uhrzeit: 16:40
# Dateispeichername: XYPScript-Promptliste-V1-0
...
bezeichner_entry = tk.Entry(entry_frame, width=30, bg="#000000", fg="#FFA500")
...
prompt_entry = tk.Entry(entry_frame, width=60, bg="#000000", fg="#FFA500")
prompt_entry.grid(row=0, column=3, padx=5)

# Eintrag übernehmen

def add_entry():
    bez = bezeichner_entry.get().strip()
    ...
    save_data()
    bezeichner_entry.delete(0, tk.END)
...
tk.Checkbutton(filter_frame, text="alle Wörter", variable=all_words_var, bg="#1F1F1F", fg="#FFA500").grid(row=0, column=1)
