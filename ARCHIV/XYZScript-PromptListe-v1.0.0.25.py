...
# Datum: 2025-04-06
# Uhrzeit: 17:05
# Dateispeichername: XYPScript-Promptliste-V25
...
VERSION = "V25"
DATA_FILE = "XYPScript-Promptliste-V25.json"
data = []
checkbox_vars = []
# Liste zur Speicherung der Editier-Widget-Referenzen (nur im Bearbeiten-Modus)
edit_widgets = []
...
def save_data():
    ...
    # Wenn im Bearbeiten-Modus, zuerst alle Änderungen übernehmen
    if ansicht_var.get() == "bearbeiten":
        for widget in edit_widgets:
            ...
            # Normalisierung: Entferne Zeilenumbrüche, splitte nach Komma und re-join mit Komma und Leerzeichen
...
def update_list():
    global edit_widgets
    # Leere alte Widgets und Listen
    for widget in scrollable_frame.winfo_children():
        widget.destroy()
    checkbox_vars.clear()
    edit_widgets = []  # Nur im Bearbeiten-Modus werden hier Editier-Referenzen gespeichert
    ...
    for idx, entry in enumerate(data):
        ...
        if ansicht_var.get() == "bearbeiten":
            ...
            # Editierbares Feld für Bezeichner
            ...
            # Mehrzeiliges, editierbares Textfeld für den Prompt mit Zeilenumbruch
            ...
            # Speichere Referenzen zur späteren Übernahme der Änderungen
            edit_widgets.append({
                "index": idx,
...
# Git-Anweisungen:
# Um Änderungen zu committen, führe folgende Befehle im Terminal aus:
# git add XYPScript-Promptliste-V25.py
# git commit -m "Version V25: Bearbeitungsmodus mit Zeilenumbruch und korrigierter Frame-Reihenfolge implementiert"
# git push
