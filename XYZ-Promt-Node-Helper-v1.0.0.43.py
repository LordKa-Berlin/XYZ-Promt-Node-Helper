...
# Neue Funktion: Zeilenumbruch in der Anzeige-Liste (Textwrap)
...
def create_bearbeiten_row(row_frame, entry, idx):
    ...
    # In der Bearbeiten-Ansicht verwenden wir die ursprüngliche Funktion, sodass der Text so angezeigt wird, wie er in der JSON steht.
    ...
    for idx, entry in enumerate(data):
        ...
        if ansicht_var.get() == "bearbeiten":
            ...
            for i, val in enumerate(values):
                # Für die Anzeige-Liste verwenden wir nun den neuen Zeilenumbruch:
