...
def create_bearbeiten_row(row_frame, entry, idx):
    ...
    # In der Bearbeiten-Ansicht verwenden wir die ursprüngliche Funktion, damit der Text unverändert übernommen wird.
...
def update_list():
    ...
    for idx, entry in enumerate(data):
        ...
        if ansicht_var.get() == "bearbeiten":
            ...
            max_buttons_per_line = 8 # Anzahl der Buttons für Zeilenumbruch
            button_count = 0
