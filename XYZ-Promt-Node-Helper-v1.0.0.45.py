...
# Ursprüngliche Funktion für den Zeilenumbruch (wird in der Bearbeiten-Ansicht verwendet)
...
def create_bearbeiten_row(row_frame, entry, idx):
    ...
    # In der Bearbeiten-Ansicht wird der Text unverändert übernommen:
...
def show_info():
    ...
    info_win.title("Über XYZ-Promt-Node-Helper")
    ...
    info_text = (
        ...
        "Version: " + VERSION + "\n\n"
        "Dieses Programm unterstützt dich bei der Vorbereitung von Prompts, "
        "die du in GUIs wie Forge oder Automatic1111 einsetzen kannst. \n\n"
        "Funktionen:\n"
        " - Einträge hinzufügen, bearbeiten und löschen\n"
        " - Automatische Sicherung (Backup) vor jedem Speichern\n"
        " - CSV-Import zur Massenanlage von Einträgen\n"
        " - Output-Modus: Kommagetrennte oder zeilenweise Ausgabe\n"
        " - Filterfunktion zur schnellen Suche in den Einträgen\n"
        " - Toggle zwischen Anzeige- und Bearbeitungsmodus\n"
        " - Gruppierung der Wert-Buttons mit Zeilenumbruch\n"
        " - Long-Press-Funktion zum Kopieren einzelner Buttons\n"
        "\n\n"
        "Nutze diese Anwendung, um schnell Vorlagen für Prompts zu erstellen, "
        "die du dann in deine gewünschte GUI einfügen kannst.\n"
    )
...
def update_list():
    ...
    for idx, entry in enumerate(data):
        ...
        if ansicht_var.get() == "bearbeiten":
            ...
            # Erstelle einen Container für die Wert-Buttons mit Zeilenumbruch nach einer definierten Anzahl:
